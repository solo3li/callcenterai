"""
Django settings for rag_core project.
...
SECRET_KEY = 'django-insecure-&5c@&g@5&nt+_^n30-*zc!o4z0l2lklsl7qw!h5@pxph@f-5%d'
...
WSGI_APPLICATION = 'rag_core.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'rag_pass'),
